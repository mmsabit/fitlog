...
const MarkAsDone = ({ workout }: { workout: fitType }) => {
  ...
  return (
    <div>
      <button
        type="button"
        className={`py-2.5 items-center rounded-full  px-5 text-[12px] font-semibold  transition  ${ismarked ? "cursor-default text-[#d7dbe0] border border-[#35404d] bg-transparent":"cursor-pointer hover:bg-[#b8ef00] bg-[#c6ff00] text-black"}`}
